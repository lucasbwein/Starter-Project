const SHELL_REVISION = '0.2.0-mac-off-diagnosis-20260903';
const CACHE = `conductor-pocket-shell-${SHELL_REVISION}`;
const SHELL = [
  '/',
  '/index.html',
  '/app.css?v=0.2.0-mac-off-diagnosis-20260903',
  '/app.js?v=0.2.0-mac-off-diagnosis-20260903',
  '/bootstrap-recovery.js?v=0.2.0-mac-off-diagnosis-20260903',
  '/delivery-receipts.js?v=0.2.0-mac-off-diagnosis-20260903',
  '/draft-conflict.js?v=0.2.0-mac-off-diagnosis-20260903',
  '/usage-state.js?v=0.2.0-mac-off-diagnosis-20260903',
  '/connection-diagnosis.js?v=0.2.0-mac-off-diagnosis-20260903',
  '/app-update.js?v=0.2.0-mac-off-diagnosis-20260903',
  '/http.js?v=0.2.0-mac-off-diagnosis-20260903',
  '/image-attachments.js?v=0.2.0-mac-off-diagnosis-20260903',
  '/live-refresh.js?v=0.2.0-mac-off-diagnosis-20260903',
  '/read-state.js?v=0.2.0-mac-off-diagnosis-20260903',
  '/rich-text.js?v=0.2.0-mac-off-diagnosis-20260903',
  '/transcript-focus.js?v=0.2.0-mac-off-diagnosis-20260903',
  '/swipe-navigation.js?v=0.2.0-mac-off-diagnosis-20260903',
  '/icon.svg',
